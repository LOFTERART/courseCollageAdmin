  ...
  <div class="createPost-main-container">
    ...
    <el-form ref="postForm" :model="postForm" :rules="rules"  label-width="80px">
      ...
      <el-form-item label="课程分类" prop="name">
        <el-input v-model="postForm.name"  placeholder="课程分类名字"  ></el-input>
      </el-form-item>

      <el-form-item label="课程备注" prop="desc">
        <el-input v-model="postForm.desc" placeholder="备注信息"  > </el-input>
      </el-form-item>

      <el-form-item label="课程名字" prop="courseTitle">
        <el-input v-model="postForm.courseTitle" placeholder="课程名字"  ></el-input>
      </el-form-item>

      <el-form-item label="课程排序" prop="sort_num">

        <div style="display: flex;flex-direction: row;align-items: center">
          <el-input v-model="postForm.sort_num" placeholder="课程排序" type="number"  style="width: 400px" ></el-input>
          ...
          this.$refs[rule].validate( async valid => {
            if (valid) {
              let params ={
                ...
                create_people:createPeople, //vuex获取
